...
//        AppConstants.baskinLogoPath 	= 	AppConstants.productCatalogPath+"AlSeerLogo";
    ...
    private void moveToLogin() {
        ...
        try {
            ...
            if (isLanguageSelected.equalsIgnoreCase(AppConstants.langEnglish)) {
...
//			AppConstants.SanFranciscoDisplay_Medium        = Typeface.createFromAsset(getApplicationContext().getAssets(), "SanFranciscoDisplay_Medium.ttf");
//			AppConstants.SanFranciscoDisplay_Semibold        = Typeface.createFromAsset(getApplicationContext().getAssets(), "SanFranciscoDisplay_Semibold.ttf");
//			AppConstants.SanFranciscoDisplay_Bold        = Typeface.createFromAsset(getApplicationContext().getAssets(), "SanFranciscoDisplay_Bold.ttf");
//			AppConstants.SanFranciscoDisplay_Regular        = Typeface.createFromAsset(getApplicationContext().getAssets(), "SanFranciscoDisplay_Regular.ttf");
...
//				setTypeFaceRobotoOriginalBold(customDialog);
            ...
            llyenglish.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    setEnglishLanguage();
                }
            });
            llyarabic.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
...
//				tvSubmit.setTypeface(AppConstants.SanFranciscoDisplay_Bold);
//				tEnglish.setTypeface(AppConstants.SanFranciscoDisplay_Medium);
//				tArabic.setTypeface(AppConstants.SanFranciscoDisplay_Medium);
    ...
    public void gotGpsValidationResponse(Object response, GPSErrorCode code) {
        if (code == GPSErrorCode.EC_GOOGLEPLAY_SERVICES_UPDATE_REQUIRED) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                ...
                showLanguagePopup(); // Handle the case for pre-M devices
            }
        }
    }
