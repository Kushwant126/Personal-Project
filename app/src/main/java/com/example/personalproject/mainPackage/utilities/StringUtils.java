...
public class StringUtils {
    ...
    public static int getIntSlow(String str) {
        ...
        try {
            ...
            LogUtils.errorLog("StringUtils", "Error occurred while parsing as integer" + e);
        }
        return value;
    }
    ...
    public static boolean getBoolean(String str) {
        ...
        try {
            ...
            LogUtils.errorLog("StringUtils", "Error occurred while parsing as boolean" + e);
        }
        return value;
    }
...
//		return (double) tmp / factor;
    ...
    public static String getString(boolean str) {
        ...
        try {
            ...
            LogUtils.errorLog("StringUtils", "Error occurred while getString" + e);
        }
        return value;
    }
...
//	}
    ...
    public static float getFloatSlow(String string) {
        ...
        try {
            ...
            LogUtils.errorLog("StringUtils", "Error occurred while getFloat" + e);
        }
    ...
    public static long getLong(String string) {
        ...
        try {
            ...
            LogUtils.errorLog("StringUtils", "Error occurred while getLong" + e);
        }
    ...
    public static int toInt(String str) {
        ...
        try {
            ...
            LogUtils.errorLog("StringUtils", "Error occurred while toInt" + e);
        }
        return value;
    }
